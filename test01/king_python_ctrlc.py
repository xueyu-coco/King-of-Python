...
GREEN = (80, 200, 80)
GRAY = (150, 150, 150)
CYAN = (0, 255, 255)  # Ctrl+C 泡泡颜色
ICE_BLUE = (173, 216, 230)  # 冻结效果颜色
...
FREEZE_DURATION = 180  # 冻结时间（3秒 = 180帧）
...
class Player:
    ...
    def draw(self, screen):
        ...
        # 如果有pow泡泡，显示指示器（冻结时不显示）
        if self.has_pow_bubble and not self.is_frozen:
