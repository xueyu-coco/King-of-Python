...
# Initialize pygame and global settings
pygame.init()

# Window
WIDTH, HEIGHT = 800, 600
screen = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("King of Python - Keyboard Demo")
...
# Key colors for keyboard platforms
KEY_COLOR = (230, 230, 235)
KEY_SIDE = (200, 200, 210)
KEY_SHADOW = (150, 150, 160)
...
MOVE_SPEED = 5
ATTACK_COOLDOWN = 30
BUBBLE_SPAWN_TIME = 180
PROJECTILE_SPEED = 6
FREEZE_DURATION = 3 * FPS
REVERSED_DURATION = 10 * FPS
...
font_bubble = pygame.font.Font(None, 18)
